...
def proc_lines():
    try:
        out = subprocess.check_output(
            ["pgrep", "-af", "spinelli_stage6b_tiled_cli.py|run_stage6E_alcubierre_robust"],
            text=True,
        )
...
def main():
    ...
    print()
    print("Stage 6E robust branch-continuation monitor")
    print("=" * 120)
    ...
    print(f"Overall configured N261 pair: {overall:5.1f}%")
    print("=" * 120)
