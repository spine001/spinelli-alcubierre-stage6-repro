#!/usr/bin/env python3
"""Optimized Stage 4 N91 production runner.
...
def main() -> int:
    ...
    parser.add_argument("--target-n", type=int, default=91)
    ...
    if args.target_n != 91:
        raise SystemExit(
            f"This production runner is locked to N=91; got {args.target_n}"
        )
    ...
    try:
        ...
        report_json = output / "stage4_n91_optimized_report.json"
        report_txt = output / "stage4_n91_optimized_report.txt"
        profile_csv = output / "stage4_n91_optimized_memory_profile.csv"
        metrics_csv = output / "stage4_n91_optimized_metrics.csv"
        ...
        lines = [
            "===== STAGE 4 N91 OPTIMIZED PRODUCTION RUN =====",
        ...
        lines += [
            "",
            "STAGE4_N91_OPTIMIZED_RUN_RESULT=PASS",
        ]
