#!/usr/bin/env python3
"""Optimized Stage 4 overnight batch case runner.
...
This runner accepts only N121, N131, N141, or N151 and emits canonical tables, metrics, and a memory profile.
"""
...
def main() -> int:
    ...
    parser.add_argument("--target-n", type=int, required=True, choices=[121, 131, 141, 151])
    parser.add_argument("--memory-budget-gib", type=float, default=1024.0)
    parser.add_argument("--delta-tau", type=float, default=0.04)
    parser.add_argument("--rtol", type=float, default=1e-8)
    parser.add_argument("--atol", type=float, default=1e-10)
    args = parser.parse_args()

    allowed_targets = {121, 131, 141, 151}
